...
Якщо архетип Purpose Seeker:
- фокус на сенсі, призначенні, виборі напрямку.

Якщо Resonant Builder:
- фокус на побудові через живу енергію, стабільність і втілення.

Якщо Vision Architect:
- фокус на системах, образі майбутнього, структурі.

Якщо Signal Walker:
- фокус на чутливості до знаків, інтуїції, тонких змінах.

Якщо Flamebearer:
- фокус на енергії, волі, дії, внутрішньому вогні.

Спочатку обери архетип на основі відповідей.
